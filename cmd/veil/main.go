...
// locked, CA error, etc.).
//
// run does NOT print the returned error: commands already route user-facing
// output through ui.FormatError inside the Cobra handler. Re-printing here
// would duplicate the "error: msg" line on stderr.
